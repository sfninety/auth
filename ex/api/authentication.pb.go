...
func (x *RegistrationRequest) GetDeviceIdentifier() string {
	if x != nil {
...
type AccessPairResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *AccessPairResponse) Reset() {
	*x = AccessPairResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ex_api_authentication_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *AccessPairResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AccessPairResponse) ProtoMessage() {}

func (x *AccessPairResponse) ProtoReflect() protoreflect.Message {
	mi := &file_ex_api_authentication_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AccessPairResponse.ProtoReflect.Descriptor instead.
func (*AccessPairResponse) Descriptor() ([]byte, []int) {
	return file_ex_api_authentication_proto_rawDescGZIP(), []int{3}
}

func (x *AccessPairResponse) GetAccessToken() string {
	if x != nil {
...
func (x *AccessPairResponse) GetRefreshToken() string {
	if x != nil {
...
func (x *AuthenticateRequest) Reset() {
	*x = AuthenticateRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ex_api_authentication_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AuthenticateRequest) Descriptor() ([]byte, []int) {
	return file_ex_api_authentication_proto_rawDescGZIP(), []int{4}
}
...
var file_ex_api_authentication_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x67, 0x22, 0x81, 0x01, 0x0a, 0x13, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x61,
	...
	0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x12, 0x2b, 0x0a, 0x11, 0x64, 0x65,
	0x76, 0x69, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x64, 0x65,
	0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x22, 0x5c, 0x0a, 0x12, 0x41, 0x63, 0x63, 0x65, 0x73,
	0x73, 0x50, 0x61, 0x69, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x21, 0x0a,
	...
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x38, 0x0a, 0x13, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74,
	0x69, 0x63, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x21, 0x0a, 0x0c,
	...
	0x21, 0x5a, 0x1f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x66,
	0x6e, 0x69, 0x6e, 0x65, 0x74, 0x79, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x2f, 0x65, 0x78, 0x2f, 0x61,
...
var file_ex_api_authentication_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_ex_api_authentication_proto_goTypes = []interface{}{
	...
	(*AccessPairResponse)(nil),  // 3: AccessPairResponse
...
func file_ex_api_authentication_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ex_api_authentication_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AccessPairResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_ex_api_authentication_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
